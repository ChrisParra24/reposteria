...
var removerHijo = function removerHijo() {
  ...
  if (numHijos === 1) {
    ...
    for (var i = 0; i < numHijos - 1; i++) {
      var hijo = document.getElementById("hijo-".concat(i));
...
var contador = 0; //añadimos botones "Nueva" y "Modificar"
...
_views_base__WEBPACK_IMPORTED_MODULE_0__.elementos.padreForRecipe.addEventListener('click', function (e) {
  if (e.target.matches('.buttonNuevaRecipe')) {
    _views_recipeView__WEBPACK_IMPORTED_MODULE_1__.removerHijo();
